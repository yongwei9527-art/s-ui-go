export default {
  ...
  main: {
    ...
    dashboard: {
      ...
      stopped: "未運行",
      welcome: "歡迎回來，管理員",
      subtitle: "S-UI 控制台 · 安全、輕量、可視化管理",
      tilesHint: "管理與添加監控信息卡片",
      backupHint: "備份數據與恢復系統配置",
      logsHint: "查看系統運行日誌與事件",
      statsHint: "查看流量與使用量統計信息",
      recentLogs: "最近日誌",
      recentLogsHint: "系統運行事件與關鍵狀態",
      viewAll: "查看全部",
      info: "信息",
      systemStatus: "系統狀態",
      systemStatusHint: "服務資源與運行狀態",
      serviceStatus: "服務狀態",
      monitorCards: "監控卡片",
      monitorCardsHint: "根據已選擇的信息卡展示實時資源數據",
      noMonitorCards: "暫無監控卡片，點擊信息卡添加",
      inboundCount: "入站數量",
      onlineUsers: "在線用戶",
      todayTraffic: "今日流量",
      systemLoad: "系統負載",
  ...
  inbounds: {
    ...
    defaultProtocolNoticeDesc: "全新安裝會自動生成 VLESS Reality、Hysteria2、TUIC、Trojan TLS、VMess WS TLS、Shadowsocks 2022、Naive TLS、AnyTLS、Hysteria TLS 默認入站和 default-user 客戶端。導出地址會自動偵測 VPS 公網地址；優先使用 443/8443/2053/2083/2087/2097/8388 等較常見端口，若端口被佔用會自動順延。Hysteria/Hysteria2/TUIC 需要放行對應 UDP 端口；自簽 TLS 模板默認開啟 insecure，正式使用建議替換為真實域名和證書。Mixed/SOCKS/HTTP 不默認公網創建，避免開放代理風險。",
    ...
    udpFirewallReminder: "請確認 VPS 防火牆和雲安全組已放行目前監聽端口的 UDP 流量。",
  },
  objects: {
    inbound: "入站",
    client: "客戶端",
  ...
  dns: {
    ...
    domainStrategy: "域名策略",
    leakGuard: "DNS 防洩漏",
    leakGuardDesc: "建議啟用：使用加密 DNS、劫持 DNS 請求，並讓本地域名走本地 DNS，減少系統 DNS 洩漏。",
    applyLeakGuard: "套用防洩漏範本",
    leakGuardApplied: "已套用 DNS 防洩漏範本，儲存後生效。",
    remoteDns: "加密遠端 DNS",
    localDns: "本地 DNS",
  ...
  tls : {
    ...
    disableSni: "停用 SNI",
    insecure: "允許不安全連線",
    realityNotice: "Reality 不需要真實證書。SNI/握手服務器應填寫穩定可訪問的 HTTPS 域名，客戶端需要匹配 public key、short_id 和 fingerprint。",
    selfSignedNotice: "默認自簽 TLS 僅用於快速初始化。客戶端需要 insecure=true；正式使用建議配置真實域名證書或 ACME。",
    fragment: "分段",
