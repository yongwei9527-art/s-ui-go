export default {
  ...
  dns: {
    ...
    leakGuard: "DNS 防泄露",
    leakGuardDesc: "推荐启用：使用加密 DNS、劫持 DNS 请求，并让本地域名走本地 DNS，减少系统 DNS 泄露。",
    leakGuardMode: "DNS 防泄露模式",
    leakGuardModes: {
      off: "关闭",
      recommended: "推荐",
      strict: "严格",
    ...
    leakGuardCheckDesc: "检查当前 DNS 与路由配置是否具备防泄露保护。",
    leakGuardPassed: "已保护",
