export default {
  ...
  dns: {
    ...
    leakGuard: "محافظ نشت DNS",
    leakGuardDesc: "پیشنهاد می‌شود: از DNS رمزنگاری‌شده استفاده کنید، درخواست‌های DNS را رهگیری کنید و دامنه‌های محلی را به DNS محلی بفرستید تا نشت DNS سیستم کاهش یابد.",
    applyLeakGuard: "اعمال قالب محافظ نشت",
    leakGuardApplied: "قالب محافظ نشت DNS اعمال شد. برای اثرگذاری ذخیره کنید.",
    remoteDns: "DNS راه دور رمزنگاری‌شده",
    localDns: "DNS محلی",
