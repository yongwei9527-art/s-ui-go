export default {
  ...
  inbounds: {
    ...
    defaultProtocolNoticeDesc: "Fresh installs automatically create VLESS Reality, Hysteria2, TUIC, Trojan TLS, VMess WS TLS, Shadowsocks 2022, Naive TLS, AnyTLS, and Hysteria TLS default inbounds plus a default-user client. Export addresses auto-detect the VPS public address. Common VPS-friendly ports such as 443/8443/2053/2083/2087/2097/8388 are preferred, and occupied ports are automatically advanced. Hysteria/Hysteria2/TUIC require UDP ports to be allowed in the VPS firewall and cloud security group. Self-signed TLS templates enable insecure by default; use a real domain and certificate for production. Mixed/SOCKS/HTTP are not created by default to avoid open-proxy exposure.",
