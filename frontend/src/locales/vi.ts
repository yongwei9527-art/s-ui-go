export default {
  ...
  dns: {
    ...
    leakGuard: "Chống rò rỉ DNS",
    leakGuardDesc: "Khuyến nghị: dùng DNS mã hóa, chặn các yêu cầu DNS và chuyển tên miền cục bộ qua DNS cục bộ để giảm rò rỉ DNS hệ thống.",
    applyLeakGuard: "Áp dụng mẫu chống rò rỉ",
    leakGuardApplied: "Đã áp dụng mẫu chống rò rỉ DNS. Hãy lưu để có hiệu lực.",
    remoteDns: "DNS từ xa được mã hóa",
    localDns: "DNS cục bộ",
