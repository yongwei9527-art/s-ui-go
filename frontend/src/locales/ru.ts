export default {
  ...
  dns: {
    ...
    leakGuard: "Защита от утечек DNS",
    leakGuardDesc: "Рекомендуется: используйте зашифрованный DNS, перехватывайте DNS-запросы и направляйте локальные домены на локальный DNS, чтобы уменьшить системные утечки DNS.",
    applyLeakGuard: "Применить шаблон защиты",
    leakGuardApplied: "Шаблон защиты от утечек DNS применён. Сохраните, чтобы изменения вступили в силу.",
    remoteDns: "Зашифрованный удалённый DNS",
